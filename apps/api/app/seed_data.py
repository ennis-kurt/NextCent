...
def seed_users(db: Session) -> None:
    ...
    for scenario in scenario_rows:
        user = User(
            persona_key=scenario["id"],
            full_name=scenario["name"],
            email=f"{scenario['id']}@demo.personal-accountant.ai",
            archetype=scenario["archetype"],
            persona_summary=scenario["summary"],
            monthly_income_estimate=scenario["monthly_income"],
            monthly_fixed_expenses_estimate=scenario["rent"] + scenario["utilities"] + scenario["insurance"] + scenario["phone"],
            savings_floor_target=scenario["savings_floor"],
