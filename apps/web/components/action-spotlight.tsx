...
export function ActionSpotlight({
  ...
  return (
    <section className="relative overflow-hidden rounded-[32px] border border-[rgba(18,32,43,0.14)] bg-[linear-gradient(135deg,rgba(19,36,47,0.98),rgba(18,32,43,0.92)_58%,rgba(31,116,104,0.85))] px-6 py-6 text-white shadow-[0_28px_64px_rgba(8,15,22,0.22)] md:px-7">
      ...
      <div className="relative grid gap-5 lg:grid-cols-[minmax(0,1.45fr)_300px] lg:items-start">
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <h2 className="max-w-3xl text-balance font-display text-3xl font-semibold leading-tight text-white md:text-[2.35rem]">
              {headline}
            </h2>
            <p className="max-w-3xl text-sm leading-7 text-white/74">{takeaway}</p>
          </div>
          <ExpandableNote
            className="max-w-3xl"
            detail={
        ...
        <div className="rounded-[28px] border border-white/12 bg-white/[0.08] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] backdrop-blur">
